...
{
    public partial class OrdersProvider
    {
        public OrdersProvider()
        {
            OrdersPlacedTasks = new HashSet<OrdersPlacedTask>();
            OrdersProviderKountRisresults = new HashSet<OrdersProviderKountRisresult>();
            OrdersProviderLineItems = new HashSet<OrdersProviderLineItem>();
        }
        ...
        public DateTime? WillShip { get; set; }
        ...
        public byte? FlagWrhsAssignment { get; set; }
        public byte? FlagSuggestedCarrier { get; set; }
        public byte? FlagBlackListCheck { get; set; }
        public byte? FlagBillAddressValidation { get; set; }
        public byte? FlagShipAddressValidation { get; set; }
        public byte? ShipAddressValidationResult { get; set; }
        public string? RateShopCarrierIdlist { get; set; }
        public int? FxrateIdcharged { get; set; }
        public int? FxrateIdsettled { get; set; }
        public string? LanguageCode { get; set; }
        public string? PayTechCustRefNum { get; set; }
        public string? PayPalNonce { get; set; }
        public string? PayPalVaultToken { get; set; }
        ...
        public virtual ICollection<OrdersProviderKountRisresult> OrdersProviderKountRisresults { get; set; }
        public virtual ICollection<OrdersProviderLineItem> OrdersProviderLineItems { get; set; }
    }
}
