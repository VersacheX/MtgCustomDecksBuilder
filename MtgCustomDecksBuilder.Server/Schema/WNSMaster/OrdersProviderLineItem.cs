...
{
    public partial class OrdersProviderLineItem
    {
        public OrdersProviderLineItem()
        {
            OrdersProviderLineItemsShipments = new HashSet<OrdersProviderLineItemsShipment>();
            Batches = new HashSet<OrdersBatchesPrinting>();
        }
        ...
        public virtual ICollection<OrdersBatchesPrinting> Batches { get; set; }
    }
}
